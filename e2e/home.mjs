...
try {
  ...
  assert.equal(await kitchenButton('Pause').count(), 0, 'no autoplay before the mouse is over a tile')
  await kitchen.hover()
  await kitchenButton('Pause').waitFor()
